...
{
    internal class ReviewDbInitializer
    {
        private readonly ReviewDbContext _context;
        private readonly ILogger<ReviewDbInitializer> _logger;

        public ReviewDbInitializer(ReviewDbContext context, ILogger<ReviewDbInitializer> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        {
            _logger.LogInformation("Migrating database associated with ReviewDbContext");
